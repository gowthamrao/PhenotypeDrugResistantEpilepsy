...
3. Once installed, you can execute the study by modifying and using the code below. For your convenience, this code is also provided under `extras/CodeToRun.R`:
	...
	outputFolder <- "c:/DrugResistantEpilepsy"
...
License
=======
The DrugResistantEpilepsy package is licensed under Apache License 2.0

Development
===========
DrugResistantEpilepsy was developed in ATLAS and R Studio.
